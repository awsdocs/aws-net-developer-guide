...
+ [Set up your AWS SDK for .NET environment](net-dg-setup.md)
   + [Create an AWS account](net-dg-signup.md)
   + [Install and configure your toolchain](net-dg-dev-env.md)
+ [Set up your AWS SDK for .NET project](net-dg-config.md)
...
+ [Deploy applications to AWS](deploying.md)
...
+ [Migrate your project for the AWS SDK for .NET](net-dg-migrating.md)
...
+ [Work with AWS services in the AWS SDK for .NET](working-with-aws-services.md)
...
+ [AWS SDK for .NET code examples](csharp_code_examples.md)
   + [Actions and scenarios using AWS SDK for .NET](csharp_code_examples_categorized.md)
      ...
      + [Aurora examples using AWS SDK for .NET](csharp_aurora_code_examples.md)
      + [Auto Scaling examples using AWS SDK for .NET](csharp_auto-scaling_code_examples.md)
      ...
      + [MediaConvert examples using AWS SDK for .NET](csharp_mediaconvert_code_examples.md)
      ...
      + [Route 53 domain registration examples using AWS SDK for .NET](csharp_route53-domains_code_examples.md)
      ...
      + [Step Functions examples using AWS SDK for .NET](csharp_sfn_code_examples.md)
   ...
   + [Cross-service examples using AWS SDK for .NET](csharp_code_examples_cross_service.md)
      ...
      + [Create a photo asset management application that lets users manage photos using labels](cross_PAM_csharp_topic.md)
