# Set up your AWS SDK for \.NET environment<a name="net-dg-setup"></a>
...
When you are finished with these topics, you can move on to [Set up your project](net-dg-config.md)\.
