...
#####################################
Listing AWS Resources using |CFNLong|
#####################################
...
For related API reference information, see :sdk-net-api:`Amazon.CloudFormation <CloudFormation/NCloudFormation>` 
and :sdk-net-api:`Amazon.CloudFormation.Model <CloudFormation/NCloudFormation>` in the 
|sdk-net-api|_.
