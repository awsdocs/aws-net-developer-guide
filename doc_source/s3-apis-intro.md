...
The AWS SDK for \.NET supports Amazon Simple Storage Service \(Amazon S3\), which is storage for the Internet\. It is designed to make web\-scale computing easier for developers\. For more information, see [Amazon S3](https://aws.amazon.com/s3/)\.
