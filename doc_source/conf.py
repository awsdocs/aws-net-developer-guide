...
#
# AWS SDK for .NET Developer Guide documentation build configuration file, created by
...
htmlhelp_basename = 'AWSNetDeveloperGuide'
...
latex_documents = [
  (master_doc, 'AWSNetDeveloperGuide.tex', project,
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'awsnetdeveloperguide', project,
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'AWSNetDeveloperGuide', project,
   author, 'AWSNetDeveloperGuide', 'One line description of project.',
   'Miscellaneous'),
]
...
# e.g. http://blogs.aws.amazon.com/net/post/Tx1P7UD2UN3DHK6/Overriding-Endpoints-in-the-AWS-SDK-for-NET
