...
You can find the corresponding content for this repo on [the AWS Documentation website](https://docs.aws.amazon.com/sdk-for-net/v3/developer-guide). If you'd like to continue contributing to the quality of AWS documentation, you can submit feedback and suggestions for improvement there.

## The [Developer guide](doc_source/index.md) for the AWS SDK for .NET

This is the open source version of the developer guide for the AWS SDK for .NET version 3.x.
